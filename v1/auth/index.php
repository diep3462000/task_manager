...
$app->post('/register', function() use ($app) {
        ...
        error_log('diepth' . $app->request->post('name'));
...
<html>
    ...
    <body>
        <header>
            <h1><a class="titulo" href="index.php">Test app</a></h1>
        </header> 
        <section class="wrapper">
            <article>
                <div id="login">
                    ...
                    <form id="log_form" action="/authenticate method="post">
                ...
                <div id="registro">
                    ...
                    <form id="reg_form" action="/register">
